	...
	<body class="col-12 m-0">
		...
		<div class="row">
			...
			<ul class="col-12 col-sm-10 nav nav-tabs m-0 p-0" id="myTab" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="mode1-tab" data-toggle="tab" href="#mode1" role="tab" aria-controls="mode1" aria-selected="true">查看考试</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="mode2-tab" data-toggle="tab" href="#mode2" role="tab" aria-controls="mode2" aria-selected="false">个人设置</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="mode3-tab" data-toggle="tab" href="#mode3" role="tab" aria-controls="mode3" aria-selected="false">大功能3</a>
				</li>
			</ul>
		</div>
			...
			<div class="col-12 tab-pane fade show active" id="mode1" role="tabpanel" aria-labelledby="mode1-tab">
				<div class="row">
					<div class="col-12 col-sm-2 nav flex-column nav-pills p-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active text-center" id="m1o1-tab" data-toggle="pill" href="#m1o1" role="tab" aria-controls="m1o1" aria-selected="true">以往考试</a>
						<a class="nav-link text-center" id="m1o2-tab" data-toggle="pill" href="#m1o2" role="tab" aria-controls="m1o2" aria-selected="false">加入考试</a>
					...
					<div class="col-12 col-sm-10 tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade show active" id="m1o1" role="tabpanel" aria-labelledby="m1o1-tab">
							<iframe src="student/examhistory.jsp" class="col-12" frameborder="0" height="800vh"></iframe>
						</div>
			...
			<div class="col-12 tab-pane fade" id="mode2" role="tabpanel" aria-labelledby="mode2-tab">
				<div class="row">
					<div class="col-12 col-sm-2 nav flex-column nav-pills p-0" id="mode2-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active text-center" id="m2o1-tab" data-toggle="pill" href="#m2o1" role="tab" aria-controls="m2o1" aria-selected="true">个人信息</a>
						<a class="nav-link text-center" id="m2o2-tab" data-toggle="pill" href="#m2o2" role="tab" aria-controls="m2o2" aria-selected="false">修改信息</a>
