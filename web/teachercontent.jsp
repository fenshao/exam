	...
	<body class="col-12 m-0">
		...
		<div class="row">
			...
			<ul class="col-12 col-sm-10 nav nav-tabs m-0 p-0" id="myTab" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="mode1-tab" data-toggle="tab" href="#mode1" role="tab" aria-controls="mode1" aria-selected="true">考试管理</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="mode2-tab" data-toggle="tab" href="#mode2" role="tab" aria-controls="mode2" aria-selected="false">学生管理</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="mode3-tab" data-toggle="tab" href="#mode3" role="tab" aria-controls="mode3" aria-selected="false">个人设置</a>
				</li>
			</ul>
		</div>
			...
			<div class="col-12 tab-pane fade show active" id="mode1" role="tabpanel" aria-labelledby="mode1-tab">
				<div class="row">
					<div class="col-12 col-sm-2 nav flex-column nav-pills p-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active text-center" id="m1o1-tab" data-toggle="pill" href="#m1o1" role="tab" aria-controls="m1o1" aria-selected="true">试题上传</a>
						<a class="nav-link text-center" id="m1o2-tab" data-toggle="pill" href="#m1o2" role="tab" aria-controls="m1o2" aria-selected="false">发布考试</a>
			...
			<div class="col-12 tab-pane fade" id="mode2" role="tabpanel" aria-labelledby="mode2-tab">
				<div class="row">
					<div class="col-12 col-sm-2 nav flex-column nav-pills p-0" id="mode2-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active text-center" id="m2o1-tab" data-toggle="pill" href="#m2o1" role="tab" aria-controls="m2o1" aria-selected="true">查询学生</a>
						<a class="nav-link text-center" id="m2o2-tab" data-toggle="pill" href="#m2o2" role="tab" aria-controls="m2o2" aria-selected="false">学生成绩</a>
			...
			<div class="col-12 tab-pane fade" id="mode3" role="tabpanel" aria-labelledby="mode3-tab">
				<div class="row">
					<div class="col-12 col-sm-2 nav flex-column nav-pills p-0" id="mode3-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active text-center" id="m3o1-tab" data-toggle="pill" href="#m3o1" role="tab" aria-controls="m3o1" aria-selected="true">修改信息</a>
						<a class="nav-link text-center" id="m3o2-tab" data-toggle="pill" href="#m3o2" role="tab" aria-controls="m3o2" aria-selected="false">修改密码</a>
						<a class="nav-link text-center" id="m3o3-tab" data-toggle="pill" href="#m3o3" role="tab" aria-controls="m3o3" aria-selected="false">小功能3</a>
					</div>
					<div class="col-12 col-sm-10 tab-content" id="v-pills-tabContent">
